...
<body>
    ...
    <div class="form">
    <h1 style="text-align: center;">ایجاد بنر تبلیغاتی</h1>
    <?php echo form_open('admin/ads/store'); ?>
        <div>
        ...
        <button style="padding: 10px; border-radius:10px; background:#4CAF50; color:#f4f4f4; " type="submit">افزودن بنر</button>
    <?php echo form_close(); ?>
    </div>
    </div>
