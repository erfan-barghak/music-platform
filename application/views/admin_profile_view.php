...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/admin_profile.css'); ?>">
...
<body>
    ...
    <!-- محتوای اصلی -->
    <div class="content" style="float: left; direction:rtl;">
    ...
    <?php echo form_open('admin_profile/update', array('class' => 'profile-form')); ?>
    <h1>پروفایل مدیر</h1>

    <label for="username">نام کاربری:</label>
    <input type="text" name="username" id="username" value="<?php echo set_value('username', $user['username']); ?>" /><br />

    <label for="email">ایمیل:</label>
    <input type="email" name="email" id="email" value="<?php echo set_value('email', $user['email']); ?>" /><br />

    <input type="submit" value="بروزرسانی پروفایل" />
    </form>

    <?php echo form_open('admin_profile/change_password', array('class' => 'change-password-form')); ?>
    <h2 style="text-align: center;">تغییر رمز عبور</h2>
